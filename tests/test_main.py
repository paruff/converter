...
from main import get_bitrate, convert_file
...
class TestConvertFile:
    ...
    @patch('main.encode')
    @patch('main.ORIG_DIR')
    def test_convert_file_h264(self, mock_orig_dir, mock_encode, mock_scale, mock_classify, mock_probe):
    ...
    @patch('main.encode')
    @patch('main.ORIG_DIR')
    def test_convert_file_mpeg1(self, mock_orig_dir, mock_encode, mock_repair, mock_scale, mock_classify, mock_probe):
